...
abstract class LocaleKeys {
  static const String _passValidation = 'passValidation';
  static String get passValidation => _passValidation.tr();

  static const String _passRequiredValidation = 'passRequiredValidation';
  static String get passRequiredValidation => _passRequiredValidation.tr();

  static const String _mailValidation = 'mailValidation';
  static String get mailValidation => _mailValidation.tr();

  static const String _phoneValidation = 'phoneValidation';
  static String get phoneValidation => _phoneValidation.tr();

  static const String _confirmValidation = 'confirmValidation';
  static String get confirmValidation => _confirmValidation.tr();

  static const String _fillField = 'fillField';
  static String get fillField => _fillField.tr();

  static const String _operationFaild = 'operationFaild';
  static String get operationFaild => _operationFaild.tr();

  static const String _progressFaild = 'progressFaild';
  static String get progressFaild => _progressFaild.tr();

  static const String _intenetWeaness = 'intenetWeaness';
  static String get intenetWeaness => _intenetWeaness.tr();

  static const String _serverError = 'serverError';
  static String get serverError => _serverError.tr();

  static const String _checkInternet = 'checkInternet';
  static String get checkInternet => _checkInternet.tr();

  static const String _errorExeptionNoconnection = 'errorExeptionNoconnection';
  ...
  static const String _errorexeptionNotcontain = 'errorExeption_NotContain';
  static String get errorexeptionNotcontain => _errorexeptionNotcontain.tr();

  static const String _errorexeptionNotcontaindesc = 'errorExeption_notContainDesc';
  static String get errorexeptionNotcontaindesc => _errorexeptionNotcontaindesc.tr();

  static const String _visitorText = 'visitorText';
  static String get visitorText => _visitorText.tr();

  static const String _expetion = 'expetion';
  static String get expetion => _expetion.tr();

  static const String _contactUs = 'contact_us';
  static String get contactUs => _contactUs.tr();

  static const String _cancele = 'cancele';
  static String get cancele => _cancele.tr();

  static const String _photoLibrary = 'PhotoLibrary';
  ...
  static String get error => _error.tr();
  ...
  static const String _notFound = 'notFound';
  static String get notFound => _notFound.tr();

  static const String _name = 'name';
  static String get name => _name.tr();

  static const String _continueAsA = 'continueAsA';
